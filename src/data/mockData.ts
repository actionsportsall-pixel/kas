...
export const HERO_IMAGE = '/imagens/surf.png';
export const SERGIO_PORTRAIT = '/imagens/sergio.jpeg';
export const PADEL_ACTION_IMAGE = '/imagens/padel.JPG';
export const SURF_BOOTCAMP_IMAGE = '/src/assets/images/surf_group_soft_light_1787149949070.jpg';
export const SURF_GROUP_EXPERIENCE_IMAGE = '/src/assets/images/surf_group_soft_light_1787149949070.jpg';
export const SUP_PADDLE_IMAGE = '/src/assets/images/stand_up_paddle_kas_1787150261094.jpg';
export const PRIVATE_SURF_SUNSET_IMAGE = '/src/assets/images/private_surf_couple_sunset_1787151221836.jpg';
